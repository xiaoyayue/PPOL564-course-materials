...
class LinearAlgebra:
    ...
    def vector(self,vector=None,add_color=None,alpha=1):
        ...
        self.plot.add_layout(Arrow(end=NormalHead(fill_color=color,fill_alpha=alpha,
                       ...
                       x_end=new_vector[0], y_end=new_vector[1],line_width=3))
    ...
    def subtract_vectors(self,vec_1=None,vec_2=None):
        ...
        self.vector(vector=vec_1)
        self.vector(vector=vec_2)
        self.vector(vector=v3,add_color = 'purple')
        hold_origin = self.origin
    ...
    def clear(self):
        ...
        self.origin = self.basis.dot(np.array([0,0])) # revert back to 0 origin
